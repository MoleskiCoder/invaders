...
void Intel8080::installInstructions() {
	instructions = {
		...
		/* 3 */	UNKNOWN(),									INS(BIND(lxi_sp), Absolute, "LXI SP,", 10),	INS(BIND(sta), Absolute, "STA ", 13),		INS(BIND(inx_sp), Implied, "INX SP", 5),	INS(BIND(inr_m), Implied, "INR M", 10),		INS(BIND(dcr_m), Implied, "DCR M", 10),			INS(BIND(mvi_m), Immediate, "MVI M,", 10),	INS(BIND(stc), Implied, "STC", 4),			UNKNOWN(),									INS(BIND(dad_sp), Implied, "DAD SP", 10),	INS(BIND(lda), Absolute, "LDA ", 13),		UNKNOWN(),									INS(BIND(inr_a), Implied, "INR A", 5),		UNKNOWN(),									INS(BIND(mvi_a), Immediate, "MVI A,", 7),	UNKNOWN(),									//	3
		...
		/* 8 */	INS(BIND(add_b), Implied, "ADD B", 4),		INS(BIND(add_c), Implied, "ADD C", 4),		INS(BIND(add_d), Implied, "ADD D", 4),		INS(BIND(add_e), Implied, "ADD E", 4),		INS(BIND(add_h), Implied, "ADD H", 4),		INS(BIND(add_l), Implied, "ADD L", 4),			INS(BIND(add_m), Implied, "ADD M", 7),		INS(BIND(add_a), Implied, "ADD A", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									//	8
		/* 9 */	INS(BIND(sub_b), Implied, "SUB B", 4),		INS(BIND(sub_c), Implied, "SUB C", 4),		INS(BIND(sub_d), Implied, "SUB D", 4),		INS(BIND(sub_e), Implied, "SUB E", 4),		INS(BIND(sub_h), Implied, "SUB H", 4),		INS(BIND(sub_l), Implied, "SUB L", 4),			INS(BIND(sub_m), Implied, "SUB M", 7),		INS(BIND(sub_a), Implied, "SUB C", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									//	9
		/* A */	INS(BIND(ana_b), Implied, "ANA B", 4),		INS(BIND(ana_c), Implied, "ANA C", 4),		INS(BIND(ana_d), Implied, "ANA D", 4),		INS(BIND(ana_e), Implied, "ANA E", 4),		INS(BIND(ana_h), Implied, "ANA H", 4),		INS(BIND(ana_l), Implied, "ANA L", 4),			INS(BIND(sub_m), Implied, "ANA M", 7),		INS(BIND(ana_a), Implied, "ANA A", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									INS(BIND(xra_a), Implied, "XRA A", 4),		//	A
		/* B */	INS(BIND(ora_b), Implied, "ORA B", 4),		INS(BIND(ora_c), Implied, "ORA C", 4),		INS(BIND(ora_d), Implied, "ORA D", 4),		INS(BIND(ora_e), Implied, "ORA E", 4),		INS(BIND(ora_h), Implied, "ORA H", 4),		INS(BIND(ora_l), Implied, "ORA L", 4),			INS(BIND(sub_m), Implied, "ORA M", 7),		INS(BIND(ora_a), Implied, "ORA A", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									INS(BIND(cmp_a), Implied, "CMP A", 4),		//	B
