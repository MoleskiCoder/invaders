...
void Intel8080::installInstructions() {
	instructions = {
		...
		/* 0 */	INS(BIND(nop), Implied, "NOP", 4),			INS(BIND(lxi_b), Absolute, "LXI B,", 10),	INS(BIND(stax_b), Implied, "STAX B", 7),	UNKNOWN(),									UNKNOWN(),									INS(BIND(dcr_b), Implied, "DCR B", 5),			INS(BIND(mvi_b), Immediate, "MVI B,", 7),	UNKNOWN(),									UNKNOWN(),									INS(BIND(dad_b), Implied, "DAD B", 10),		INS(BIND(ldax_b), Implied, "LDAX B", 7),	UNKNOWN(),									UNKNOWN(),									INS(BIND(dcr_c), Implied, "DCR C", 5),		INS(BIND(mvi_c), Immediate, "MVI C,", 7),	INS(BIND(rrc), Implied, "RRC", 4),			//	0
		/* 1 */	UNKNOWN(),									INS(BIND(lxi_d), Absolute, "LXI D,", 10),	INS(BIND(stax_d), Implied, "STAX D", 7),	INS(BIND(inx_d), Implied, "INX D", 5),		INS(BIND(inr_d), Implied, "INR D", 5),		UNKNOWN(),										UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									INS(BIND(dad_d), Implied, "DAD D", 10),		INS(BIND(ldax_d), Implied, "LDAX D", 7),	UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									INS(BIND(mvi_e), Immediate, "MVI E,", 7),	UNKNOWN(),									//	1
		/* 2 */	UNKNOWN(),									INS(BIND(lxi_h), Absolute, "LXI H,", 10),	INS(BIND(shld), Absolute, "SHLD", 16),		INS(BIND(inx_h), Implied, "INX H", 5),		INS(BIND(inr_h), Implied, "INR H", 5),		UNKNOWN(),										INS(BIND(mvi_h), Immediate, "MVI H,",7),	UNKNOWN(),									UNKNOWN(),									INS(BIND(dad_h), Implied, "DAD H", 10),		INS(BIND(lhld), Absolute, "LHLD ", 16),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									INS(BIND(mvi_l), Immediate, "MVI L,", 7),	UNKNOWN(),									//	2
		/* 3 */	UNKNOWN(),									INS(BIND(lxi_sp), Absolute, "LXI SP,", 10),	INS(BIND(sta), Absolute, "STA ", 13),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),										INS(BIND(mvi_m), Immediate, "MVI M,", 10),	UNKNOWN(),									UNKNOWN(),									INS(BIND(dad_sp), Implied, "DAD SP", 10),	INS(BIND(lda), Absolute, "LDA ", 13),		UNKNOWN(),									INS(BIND(inr_a), Implied, "INR A", 5),		UNKNOWN(),									INS(BIND(mvi_a), Immediate, "MVI A,", 7),	UNKNOWN(),									//	3
		...
		/* 8 */	INS(BIND(add_b), Implied, "ADD B", 4),		INS(BIND(add_c), Implied, "ADD C", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),										UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									//	8
		/* 9 */	INS(BIND(sub_b), Implied, "SUB B", 4),		INS(BIND(sub_c), Implied, "SUB C", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),										UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									//	9
		/* A */	INS(BIND(ana_b), Implied, "ANA B", 4),		INS(BIND(ana_c), Implied, "ANA C", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),										UNKNOWN(),									INS(BIND(ana_a), Implied, "ANA A", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									INS(BIND(xra_a), Implied, "XRA A", 4),		//	A
		/* B */	INS(BIND(ora_b), Implied, "ORA B", 4),		INS(BIND(ora_c), Implied, "ORA C", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),										UNKNOWN(),									INS(BIND(ora_a), Implied, "ORA A", 4),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									INS(BIND(cmp_a), Implied, "CMP A", 4),		//	B
		/* C */	INS(BIND(rnz), Implied, "RNZ", 5),			INS(BIND(pop_b), Implied, "POP B", 10),		INS(BIND(jnz), Absolute, "JNZ ", 10),		INS(BIND(jmp), Absolute, "JMP ", 10),		INS(BIND(cnz), Absolute, "CNZ ", 11),		INS(BIND(push_b), Implied, "PUSH B", 11),		INS(BIND(adi), Immediate, "ADI ", 7),		INS(BIND(rst_0), Implied, "RST 0", 11),		INS(BIND(rz), Implied, "RZ", 11),			INS(BIND(ret), Implied, "RET", 10),			INS(BIND(jz), Absolute, "JZ ", 10),			UNKNOWN(),									INS(BIND(cz), Absolute, "CZ ", 11),			INS(BIND(call), Absolute, "CALL ", 17),		UNKNOWN(),									INS(BIND(rst_1), Implied, "RST 1", 11),		//	C
		/* D */	INS(BIND(rnc), Implied, "RNC", 5),			INS(BIND(pop_d), Implied, "POP D", 10),		INS(BIND(jnc), Absolute, "JNC ", 10),		INS(BIND(out), Immediate, "OUT ", 10),		INS(BIND(cnc), Absolute, "CNC ", 11),		INS(BIND(push_d), Implied, "PUSH D", 11),		UNKNOWN(),									INS(BIND(rst_2), Implied, "RST 2", 11),		INS(BIND(rc), Implied, "RC", 11),			UNKNOWN(),									INS(BIND(jc), Absolute, "JC ", 10),			UNKNOWN(),									INS(BIND(cc), Absolute, "CC ", 11),			UNKNOWN(),									UNKNOWN(),									INS(BIND(rst_3), Implied, "RST 3", 11),		//	D
		/* E */	INS(BIND(rpo), Implied, "RPO", 5),			INS(BIND(pop_h), Implied, "POP H", 10),		INS(BIND(jpo), Absolute, "JPO ", 10),		INS(BIND(xhtl),	Implied, "XHTL", 18),		INS(BIND(cpo), Absolute, "CPO ", 11),		INS(BIND(push_h), Implied, "PUSH H", 11),		INS(BIND(ani), Immediate, "ANI ", 7),		INS(BIND(rst_4), Implied, "RST 4", 11),		INS(BIND(rpe), Implied, "RPE", 11),			INS(BIND(pchl), Implied, "PCHL", 5),		INS(BIND(jpe), Absolute, "JPE ", 10),		INS(BIND(xchg), Implied, "XCHG", 4),		INS(BIND(cpe), Absolute, "CPE ", 11),		UNKNOWN(),									UNKNOWN(),									INS(BIND(rst_5), Implied, "RST 5", 11),		//	E
		/* F */	INS(BIND(rp), Implied, "RP", 5),			INS(BIND(pop_psw), Implied, "POP PSW", 10),	INS(BIND(jp), Absolute, "JP ", 10),			INS(BIND(di), Implied, "DI ", 4),			INS(BIND(cp), Absolute, "CP ", 11),			INS(BIND(push_psw), Implied, "PUSH PSW", 11),	UNKNOWN(),									INS(BIND(rst_6), Implied, "RST 6", 11),		INS(BIND(rm), Implied, "RM", 11),			INS(BIND(sphl), Implied, "SPHL", 5),		INS(BIND(jm), Absolute, "JM ", 10),			INS(BIND(ei), Implied, "EI", 4),			INS(BIND(cm), Absolute, "CM ", 11),			UNKNOWN(),									INS(BIND(cpi), Immediate, "CPI ", 7),		INS(BIND(rst_7), Implied, "RST 7", 11),		//	F
	};
}
