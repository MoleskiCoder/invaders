...
void Intel8080::installInstructions() {
	instructions = {
		...
		/* 3 */	UNKNOWN(),									INS(BIND(lxi_sp), Absolute, "LXI SP,", 10),	INS(BIND(sta), Absolute, "STA ", 13),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),										INS(BIND(mvi_m), Immediate, "MVI M,", 10),	UNKNOWN(),									UNKNOWN(),									INS(BIND(dad_sp), Implied, "DAD SP", 10),	INS(BIND(lda), Absolute, "LDA ", 13),		UNKNOWN(),									UNKNOWN(),									UNKNOWN(),									INS(BIND(mvi_a), Immediate, "MVI A,", 7),	UNKNOWN(),									//	3
		...
		/* F */	INS(BIND(rp), Implied, "RP", 5),			INS(BIND(pop_psw), Implied, "POP PSW", 10),	UNKNOWN(),									INS(BIND(di), Implied, "DI ", 4),			INS(BIND(cp), Absolute, "CP ", 11),			INS(BIND(push_psw), Implied, "PUSH PSW", 11),	UNKNOWN(),									INS(BIND(rst_6), Implied, "RST 6", 11),		INS(BIND(rm), Implied, "RM", 11),			UNKNOWN(),									INS(BIND(jm), Absolute, "JM ", 10),			INS(BIND(ei), Implied, "EI", 4),			INS(BIND(cm), Absolute, "CM ", 11),			UNKNOWN(),									INS(BIND(cpi), Immediate, "CPI ", 7),		INS(BIND(rst_7), Implied, "RST 7", 11),		//	F
	};
}
